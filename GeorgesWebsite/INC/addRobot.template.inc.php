<div id="f_login">
    <form method ='post' action="testForm.php" onsubmit="return sendForm(this)" id="sendLogin" class="w3-container w3-card-4 w3-light-grey w3-text-black w3-margin">
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" type="text" name="robotID" id="robotID" placeholder="robotID" required>
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border" type="password" name="robotPsw" id="robotPsw" placeholder="robotPsw" required>
            </div>
        </div>
